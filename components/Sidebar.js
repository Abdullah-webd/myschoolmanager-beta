  ...
  const getMenuItems = () => {
    ...
    const roleSpecificItems = {
      admin: [
        ...
        { href: `/dashboard/${user.role}/users`, icon: Users, label: 'Manage Users' },
        { href: `/dashboard/${user.role}/bulk-messaging`, icon: Users, label: 'Send Messages' },
        { href: `/dashboard/${user.role}/analytics`, icon: BarChart, label: 'Analytics' },
        { href: `/dashboard/${user.role}/settings`, icon: Settings, label: 'Settings' },
        { 
      ...
      teacher: [
        { href: `/dashboard/${user.role}/students`, icon: Users, label: 'My Students' },
        { href: `/dashboard/${user.role}/exams`, icon: FileText, label: 'My Exams' },
        { href: `/dashboard/${user.role}/assignments`, icon: ClipboardList, label: 'Assignments' },
        { href: `/dashboard/${user.role}/reports`, icon: BarChart, label: 'Reports' },
        { href: `/dashboard/${user.role}/courses`, icon: BookOpen, label: 'Courses' },
        { href: `/dashboard/${user.role}/print-exams`, icon: Printer, label: 'Print Exams' },
        { href: `/dashboard/${user.role}/settings`, icon: Settings, label: 'Settings' },
        { href: `/dashboard/${user.role}`, icon: Home, label: 'Dashboard' },
      { href: `/dashboard/${user.role}/ai`, icon: Bot, label: 'AI Assistant' },
      { href: `/dashboard/${user.role}/notes`, icon: StickyNote, label: 'Notes' },
      { 
        href: `/dashboard/${user.role}/notifications`, 
        icon: Bell, 
        label: 'Notifications',
