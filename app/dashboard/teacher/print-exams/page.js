...
export default function PrintExams() {
    ...
    let content = `
      <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #333; padding-bottom: 20px;">
          ...
          <p style="margin: 10px 0; color: #666;">Subject: ${
            exam.subject
          } | Class: ${exam.class}</p>
          <p style="margin: 5px 0; color: #666;">Duration: ${
            exam.duration
          } minutes | Total Marks: ${exam.totalMarks}</p>
      ...
      if (question.type === "multiple-choice" && question.options) {
        ...
        question.options.forEach((option, optIndex) => {
          ...
          content += `
            ...
            isCorrect
              ? '<span style="color: #22c55e; font-weight: bold;">(Correct Answer)</span>'
              : ""
          }
            </div>
          `;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        content: "Exam content saved successfully!",
      });
      setIsEditing(false);
    } catch (error) {
                ...
                <main className="flex-1 p-6 lg:p-8">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                      Select an exam to view and print in document format
                    </p>
                  </div>
