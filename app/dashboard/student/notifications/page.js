...
import { Bell, Search, Filter, Mail, AlertCircle, CheckCircle, Info, Clock, Trash2, BookMarked as MarkAsRead } from 'lucide-react';
...
export default function StudentNotifications() {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      case 'exam': return <Bell className="w-5 h-5 text-blue-500" />;
      case 'assignment': return <Bell className="w-5 h-5 text-purple-500" />;
