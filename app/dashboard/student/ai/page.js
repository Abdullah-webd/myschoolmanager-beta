          ...
          <div className="flex-1 flex">
            ...
            <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600">Get help with your studies, homework, or ask questions about any subject.</p>
              </div>
                ...
                {sessions.map((session) => (
                  <div
                    ...
                    className={`p-4 border-b border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors ${
                      currentSession?.sessionId === session.sessionId ? 'bg-blue-50 border-l-4 border-l-blue-500' : ''
                    }`}
                  >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Get help with your studies, homework, or ask questions about any subject
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                {messages.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-6">Ask me about any subject, homework help, or study tips.</p>
