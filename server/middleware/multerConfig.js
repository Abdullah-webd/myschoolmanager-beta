...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const uploadPath = 'uploads/assignments'; // or parametrize this if you want
...
const createMulterUpload = (folderName = 'uploads/assignments') => {
  // Make sure folder exists dynamically based on folderName param
